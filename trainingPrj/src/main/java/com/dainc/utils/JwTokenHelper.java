...
public class JwTokenHelper {
	...
	private static final String SECRET_KEY = "daincdotcom-token-base-authentication-with-jwt-example";

	private static final String ISSUER = "https://dainc.com";

	private JwTokenHelper() {
		super();
	}

	public static String createJWT(MstUserModel user) {
	 ...
	 */
	public static MstUserModel getUserFromToken(String token) {
